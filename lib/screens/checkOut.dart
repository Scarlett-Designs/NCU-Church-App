...
import 'package:church/services/paymentCheckoutService.dart';
...
class _CheckoutPageState extends State<CheckoutPage> {
  ...
  String get initialUrl => 'https://xdandreas.github.io/paymentpage/index.html';
  String aKey = Constants.apiKey;

  Future<void> _redirectToStripe(String sessionId) async {
    final redirectToCheckoutJs = '''
var stripe = Stripe(\'$aKey\');
